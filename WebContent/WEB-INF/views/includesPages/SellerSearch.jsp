    ...
    <div class="container_16">
        <div class="grid_16">
            ...
            <div class="grid_6" id="topNav">
                    ...
                    <ul>
                    <li><a href="empHome.htm">HOME</a></li>
    ...
    $(document).ready(function (){
        ...
        $('#search').keyup (function (){
            ...
            if (searchbar.length >= 3){
                ...
                $('#loadSearches').css('display');
                $.post('findProductLoad.htm', {searchbar:searchbar}, function (data){
                    //alert (data);
                    if (data.length > 760){
...
<div class="container_16" id="loadSearches" >
            ...
            <div class="grid_15 push_1">
                ...
                <div class="clear"></div>
                        ...
                        <c:forEach var="search" items="${sessionScope.searchResult}">
                        <div class="grid_14">
                            <div class="grid_10">
                            
                            <p id="info"><a href="product.jsp?id=<c:out value="${search.productName}"/>"></a>
                            </div>
                        </div>
                        </c:forEach>
                        <div class="clear"></div>
